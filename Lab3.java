...
public static void main(String[] args) throws Exception {
	 ...
	 *it adds all the names to the top200 arraylist in the order that they were in in the csv file (including duplicates)*/
        ...
        /* I made my own custom Artist node and LinkedList classes for this lab, I am now instantiating my custom LinkedList below and I 
        ...
        /*I initially made a displayList method.... but, since the lab requires that it be printed to file, instead of to the console
         *I instead made a method in my custom LinkedList and Node classes that would print the list to an output file, and it would 
         *take in the printwriter used to print to the output file as a parameter*/
